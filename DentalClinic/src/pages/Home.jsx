...
const Hero = () => (
  <section className="relative overflow-hidden bg-linear-to-br from-[#EBF0FC] via-[#F8FAFF] to-[#FEF0F0] min-h-[90vh] flex items-center">
    {/* Ambient blobs */}
    <div className="absolute -top-32 -left-32 w-125 h-125 rounded-full bg-blue-100 opacity-50 blur-3xl pointer-events-none" />
    <div className="absolute -bottom-24 right-0 w-96 h-96 rounded-full bg-red-100 opacity-30 blur-3xl pointer-events-none" />

    <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-16 py-16 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
      {/* ── Left — content ─────────────────────────────── */}
      <div className="flex flex-col gap-7">
        {/* pill badge */}
        <div className="inline-flex items-center gap-2 bg-white border border-[#B8CCF0] rounded-full px-4 py-2 w-fit shadow-sm">
          <span className="w-2 h-2 rounded-full bg-[#C0161B] animate-pulse" />
          <span className="text-xs font-semibold text-[#1B4FBE]">
            Specialized for Women & Children
          </span>
        </div>

        {/* headline */}
        <h1 className="font-serif text-4xl md:text-5xl lg:text-[54px] font-bold text-[#1A2744] leading-[1.1]">
          Specialized Dental
          <br />
          Care for <span className="text-[#1B4FBE]">Women,</span>
          <br />
          <span className="text-[#C0161B]">Children</span> &amp; Families
        </h1>
        ...
        {/* CTAs */}
        <div className="flex flex-wrap gap-3">
          <button className="bg-linear-to-r from-[#1B4FBE] to-[#4A7FD4] text-white font-semibold px-7 py-3.5 rounded-full shadow-lg shadow-blue-200 hover:shadow-xl transition-all flex items-center gap-2 text-sm">
            🗓 Fix an Appointment <ArrowRight size={15} />
          </button>
          <button className="bg-white border border-slate-200 text-[#1A2744] font-semibold px-7 py-3.5 rounded-full hover:border-[#C0161B] hover:text-[#C0161B] transition-colors text-sm">
            🚨 Emergency Support
          </button>
        </div>
      </div>
      ...
      <div className="relative flex justify-center items-center">
        <div className="relative w-full max-w-110">
          ...
          <div className="absolute -z-10 -top-3 -right-3 w-full h-full rounded-3xl border-2 border-[#1B4FBE]/20" />
          <div className="absolute -z-10 -top-6 -right-6 w-full h-full rounded-3xl border border-[#C0161B]/15" />

          {/* image box — fixed height, object-bottom to show clinic interior */}
          <div className="relative w-full h-120 rounded-3xl overflow-hidden shadow-2xl shadow-blue-200">
            <img
              src={heroImage}
              alt="Sakthi Dental Clinic"
              className="w-full h-full object-cover object-bottom"
            />
            {/* subtle blue tint overlay at top */}
            <div className="absolute inset-0 bg-linear-to-b from-[#1B4FBE]/10 via-transparent to-[#1A2744]/20" />
          </div>

          {/* Floating card — Rating (right) */}
          <div className="absolute -right-12 top-1/2 -translate-y-1/2 bg-white rounded-2xl px-4 py-3 shadow-xl border border-slate-100 flex items-center gap-3 min-w-max">
            <div className="w-10 h-10 bg-amber-50 rounded-xl flex items-center justify-center text-lg shrink-0">
              ⭐
            </div>
            <div className="leading-tight">
              <strong className="block text-sm text-[#1A2744]">4.9 / 5</strong>
          ...
          <div className="absolute -bottom-5 left-1/2 -translate-x-1/2 bg-linear-to-r from-[#1B4FBE] to-[#4A7FD4] text-white rounded-full px-6 py-2.5 shadow-lg text-xs font-semibold whitespace-nowrap flex items-center gap-2">
            <span>🏅</span> 20+ Years of Trusted Care
          </div>
        </div>
      </div>
...
const TrustBanner = () => (
  <section className="bg-linear-to-r from-[#1B4FBE] to-[#1A3F9A] text-white">
    <div className="max-w-6xl mx-auto px-6 md:px-12 py-8 flex flex-col md:flex-row items-center justify-between gap-6">
      <div>
        <h2 className="font-serif text-2xl font-bold">
          You are always in safe hands.
...
const WhyChooseUs = () => (
  <section className="max-w-6xl mx-auto px-6 md:px-12 py-20">
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
      {/* Left text */}
      <div>
        <span className="text-xs font-semibold tracking-[2.5px] uppercase text-[#C0161B] block mb-3">
          Why Choose Us
        </span>
        <h2 className="font-serif text-4xl font-bold text-[#1A2744] leading-tight mb-5">
          What Makes Sakthi Dental Stand Apart
        ...
        <a
          href="/about"
          className="inline-flex items-center gap-2 text-[#1B4FBE] text-sm font-semibold hover:gap-3 transition-all"
        >
          Meet our doctors <ArrowRight size={15} />
        </a>
      </div>
        ...
        {whyUs.map(({ icon, title, desc }, i) => (
          <div
            ...
            className={`rounded-2xl p-6 border transition-all duration-300 hover:shadow-lg group
              ${
                i === 0
                  ? "bg-linear-to-br from-[#1B4FBE] to-[#4A7FD4] border-transparent text-white"
                  : "bg-[#F8FAFF] border-slate-200 hover:border-[#1B4FBE]"
              }`}
          >
            <div
              className={`w-11 h-11 rounded-xl flex items-center justify-center text-xl mb-4
                ${
                  i === 0
                    ? "bg-white/20"
                    : "bg-[#EBF0FC] group-hover:bg-[#1B4FBE] group-hover:text-white transition-colors"
                }`}
            >
              {icon}
            </div>
    ...
    <div className="max-w-6xl mx-auto px-6 md:px-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 mb-10">
        {treatments.map(({ icon, title, desc }) => (
          <div
            key={title}
            className="bg-white border flex border-slate-200 rounded-2xl p-6 hover:border-[#1B4FBE] hover:shadow-lg hover:shadow-blue-50 transition-all duration-300 group cursor-pointer"
          >
            <div className="flex items-center gap-4 justify-between mb-5">
              <div className="w-16 h-10 bg-linear-to-br from-[#EBF0FC] to-[#F0EAFC] rounded-full flex items-center justify-center text-2xl group-hover:scale-110 transition-transform duration-300 shadow-sm">
                {icon}
              </div>
              <div>
                <h3 className="font-semibold text-[#1A2744] text-sm mb-2 group-hover:text-[#1B4FBE] transition-colors">
                  {title}
                </h3>
                <p className="text-slate-400 text-xs leading-relaxed">{desc}</p>
              </div>
      ...
      <div className="text-center">
        <Link to="/treatments">
          <button className="bg-linear-to-r from-[#1B4FBE] to-[#4A7FD4] text-white font-semibold px-8 py-3.5 rounded-full shadow-md shadow-blue-200 hover:shadow-lg transition-shadow text-sm flex items-center gap-2 mx-auto">
            View Full List of Treatments <ArrowRight size={15} />
          </button>
        </Link>
      </div>
    ...
    <section className="max-w-6xl mx-auto px-6 md:px-12 py-20">
        ...
        {testimonials.map(({ name, avatar, color, role, rating, text }, i) => (
          <div
            ...
            className={`rounded-2xl p-7 border transition-all duration-300 relative
              ${
                i === 1
                  ? "bg-linear-to-br from-[#1B4FBE] to-[#1A3F9A] border-transparent text-white shadow-xl shadow-blue-200 scale-105"
                  : "bg-white border-slate-200 hover:border-[#1B4FBE] hover:shadow-md"
              }`}
          >
            <span
              className={`absolute top-5 right-6 font-serif text-5xl leading-none select-none
      ...
      <div className="md:hidden">
        ...
        <div className="flex justify-center gap-3 mt-5">
          <button
            onClick={prev}
            className="w-9 h-9 rounded-full border border-slate-200 flex items-center justify-center hover:border-[#1B4FBE] hover:text-[#1B4FBE] transition-colors"
          >
            <ChevronLeft size={16} />
          </button>
          {testimonials.map((_, i) => (
            <button
              key={i}
              onClick={() => setActive(i)}
              className={`w-2 h-2 rounded-full transition-all duration-200 ${i === active ? "bg-[#1B4FBE] w-6" : "bg-slate-200"}`}
            />
          ))}
          <button
            onClick={next}
...
const Amenities = () => (
  <section className="bg-linear-to-br from-[#1A2744] to-[#1A3F9A] py-20">
    <div className="max-w-6xl mx-auto px-6 md:px-12">
      <div className="text-center mb-14">
        <span className="text-xs font-semibold tracking-[2.5px] uppercase text-blue-300 block mb-3">
          Clinic Facilities
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
        {amenities.map(({ icon, label, desc }) => (
          <div
            key={label}
            className="bg-white/10 border border-white/15 flex flex-col items-center justify-center rounded-2xl p-6 text-center hover:bg-white/20 transition-all duration-300 group"
          >
            <div className="text-3xl items-center mb-4 group-hover:scale-110 transition-transform duration-300">
              {icon}
            </div>
...
const CTAStrip = () => (
  <section className="bg-white border-t border-slate-100">
    <div className="max-w-6xl mx-auto px-6 md:px-12 py-16 flex flex-col md:flex-row items-center justify-between gap-8">
      <div className="text-center md:text-left">
        <span className="text-xs font-semibold tracking-[2.5px] uppercase text-[#C0161B] block mb-2">
          Book Today
        </span>
        <h2 className="font-serif text-3xl font-bold text-[#1A2744] mb-2">
          Ready for a healthier smile?
      ...
      <div className="flex flex-col sm:flex-row gap-3 shrink-0">
        <button className="bg-linear-to-r from-[#1B4FBE] to-[#4A7FD4] text-white font-semibold px-8 py-3.5 rounded-full shadow-md shadow-blue-200 hover:shadow-lg transition-shadow text-sm flex items-center gap-2 justify-center">
          🗓 Fix an Appointment <ArrowRight size={14} />
        </button>
        <button className="border border-slate-200 text-[#1A2744] font-semibold px-8 py-3.5 rounded-full hover:border-[#C0161B] hover:text-[#C0161B] transition-colors text-sm">
          📞 +91 98628 90897
        </button>
      </div>
    </div>
